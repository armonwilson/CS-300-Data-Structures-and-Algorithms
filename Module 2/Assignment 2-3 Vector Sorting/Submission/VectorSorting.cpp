...
void quickSort(vector<Bid>& bids, int begin, int end) {
    ...
    if (mid - begin < end - mid) {
        quickSort(bids, begin, mid); // Recursively sort smaller part
        begin = mid + 1; // Update begin for the larger part
    }

    // recursively sort high partition (mid+1 to end)
    else {
        quickSort(bids, mid + 1, end); // Recursively sort smaller part
        end = mid; // Update end for the larger part
    }
}
...
void selectionSort(vector<Bid>& bids) {
    ...
    cout << "Vector Size = " << bids.size() << endl;

    // set size_t platform-neutral result equal to bid.size()
    size_t size_t = bids.size();
...
int main(int argc, char* argv[]) {
    ...
    case 2:
        ...
        break;
    default:
        csvPath = "src\\resources\\CS 300 eBid_Monthly_Sales.csv";
    }
